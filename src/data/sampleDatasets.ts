...
export const SAMPLE_DATASETS: SampleDataset[] = [
  ...
  },
  {
    id: 'base_stations',
    name: '基站分布',
    description: '全国主要城市基站经纬度与信号指标（40行，可地图可视化）',
    icon: '📡',
    rows: [
      { station: 'BJ-001', city: '北京', longitude: 116.4074, latitude: 39.9042, signalStrength: 82, users: 3200, bandwidth: 180 },
      { station: 'BJ-002', city: '北京', longitude: 116.4551, latitude: 39.9097, signalStrength: 75, users: 2800, bandwidth: 150 },
      { station: 'BJ-003', city: '北京', longitude: 116.3615, latitude: 39.8878, signalStrength: 88, users: 4100, bandwidth: 220 },
      { station: 'SH-001', city: '上海', longitude: 121.4737, latitude: 31.2304, signalStrength: 90, users: 4500, bandwidth: 240 },
      { station: 'SH-002', city: '上海', longitude: 121.5200, latitude: 31.1900, signalStrength: 78, users: 3100, bandwidth: 160 },
      { station: 'SH-003', city: '上海', longitude: 121.4200, latitude: 31.2800, signalStrength: 85, users: 3800, bandwidth: 200 },
      { station: 'GZ-001', city: '广州', longitude: 113.2644, latitude: 23.1291, signalStrength: 80, users: 3400, bandwidth: 175 },
      { station: 'GZ-002', city: '广州', longitude: 113.3700, latitude: 23.1100, signalStrength: 72, users: 2600, bandwidth: 140 },
      { station: 'SZ-001', city: '深圳', longitude: 114.0579, latitude: 22.5431, signalStrength: 86, users: 4000, bandwidth: 210 },
      { station: 'SZ-002', city: '深圳', longitude: 114.1400, latitude: 22.5800, signalStrength: 79, users: 3300, bandwidth: 170 },
      { station: 'CD-001', city: '成都', longitude: 104.0665, latitude: 30.5723, signalStrength: 74, users: 2900, bandwidth: 150 },
      { station: 'CD-002', city: '成都', longitude: 104.1200, latitude: 30.6500, signalStrength: 83, users: 3600, bandwidth: 190 },
      { station: 'HZ-001', city: '杭州', longitude: 120.1551, latitude: 30.2741, signalStrength: 81, users: 3500, bandwidth: 185 },
      { station: 'HZ-002', city: '杭州', longitude: 120.2100, latitude: 30.3000, signalStrength: 76, users: 3000, bandwidth: 155 },
      { station: 'WH-001', city: '武汉', longitude: 114.3052, latitude: 30.5928, signalStrength: 77, users: 3100, bandwidth: 158 },
      { station: 'NJ-001', city: '南京', longitude: 118.7969, latitude: 32.0603, signalStrength: 79, users: 3200, bandwidth: 168 },
      { station: 'NJ-002', city: '南京', longitude: 118.8700, latitude: 32.1000, signalStrength: 84, users: 3700, bandwidth: 195 },
      { station: 'XA-001', city: '西安', longitude: 108.9398, latitude: 34.3416, signalStrength: 73, users: 2800, bandwidth: 145 },
      { station: 'XA-002', city: '西安', longitude: 109.0000, latitude: 34.4000, signalStrength: 80, users: 3400, bandwidth: 178 },
      { station: 'CQ-001', city: '重庆', longitude: 106.5516, latitude: 29.5630, signalStrength: 71, users: 2700, bandwidth: 138 },
      { station: 'CQ-002', city: '重庆', longitude: 106.6000, latitude: 29.6200, signalStrength: 78, users: 3200, bandwidth: 165 },
      { station: 'CQ-003', city: '重庆', longitude: 106.5100, latitude: 29.5500, signalStrength: 82, users: 3550, bandwidth: 188 },
      { station: 'SZ-C-001', city: '苏州', longitude: 120.5853, latitude: 31.2989, signalStrength: 83, users: 3600, bandwidth: 192 },
      { station: 'TJ-001', city: '天津', longitude: 117.2009, latitude: 39.0842, signalStrength: 74, users: 2900, bandwidth: 150 },
      { station: 'TJ-002', city: '天津', longitude: 117.2700, latitude: 39.1300, signalStrength: 80, users: 3350, bandwidth: 172 },
      { station: 'CS-001', city: '长沙', longitude: 112.9388, latitude: 28.2282, signalStrength: 72, users: 2750, bandwidth: 142 },
      { station: 'CS-002', city: '长沙', longitude: 112.9900, latitude: 28.2800, signalStrength: 79, users: 3250, bandwidth: 166 },
      { station: 'QD-001', city: '青岛', longitude: 120.3826, latitude: 36.0671, signalStrength: 75, users: 2950, bandwidth: 152 },
      { station: 'ZZ-001', city: '郑州', longitude: 113.6254, latitude: 34.7466, signalStrength: 76, users: 3050, bandwidth: 158 },
      { station: 'ZZ-002', city: '郑州', longitude: 113.6900, latitude: 34.8000, signalStrength: 81, users: 3450, bandwidth: 180 },
      { station: 'NB-001', city: '宁波', longitude: 121.5440, latitude: 29.8683, signalStrength: 78, users: 3150, bandwidth: 162 },
      { station: 'KM-001', city: '昆明', longitude: 102.8329, latitude: 24.8801, signalStrength: 70, users: 2600, bandwidth: 135 },
      { station: 'DL-001', city: '大连', longitude: 121.6147, latitude: 38.9140, signalStrength: 73, users: 2800, bandwidth: 146 },
      { station: 'XM-001', city: '厦门', longitude: 118.0894, latitude: 24.4798, signalStrength: 82, users: 3500, bandwidth: 186 },
      { station: 'FZ-001', city: '福州', longitude: 119.2965, latitude: 26.0745, signalStrength: 74, users: 2850, bandwidth: 148 },
      { station: 'HF-001', city: '合肥', longitude: 117.2272, latitude: 31.8206, signalStrength: 77, users: 3080, bandwidth: 160 },
      { station: 'XY-001', city: '咸阳', longitude: 108.7088, latitude: 34.3296, signalStrength: 71, users: 2650, bandwidth: 137 },
      { station: 'PY-001', city: '濮阳', longitude: 115.0300, latitude: 35.7600, signalStrength: 68, users: 2400, bandwidth: 128 },
      { station: 'CZ-001', city: '沧州', longitude: 116.8574, latitude: 38.3106, signalStrength: 69, users: 2500, bandwidth: 130 },
      { station: 'BZ-001', city: '滨州', longitude: 117.9700, latitude: 37.3820, signalStrength: 70, users: 2550, bandwidth: 132 },
    ],
  },
]
